...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    const ahmet = message.channel.send({
      embeds: [embed
       ...
       **1 gün** içerisinde ${rakam(message.guild.members.cache.filter(ahmet => (new Date().getTime() - ahmet.joinedTimestamp) < 1000 * 60 * 60 * 24).size)} kullanıcı giriş yapmış.
