...
module.exports = {
    ...
    run: async (client, message, args, embed, prefix) => {
        ...
        if(choose === "help") {
            ...
            .setFooter("© Developed By Ahmet")
            .setTimestamp() // Meriaz ADAMDIR 
            .setDescription(`
\`\`\`SUNUCU AYARLARI\`\`\`
Ahmet \`(.setup ahmet <@ahmet>)\`
...
`)
        ...
        let ahmet = await config.findOne({guildID: settings.guildID})
        ...
        if(["publicParents"].some(x => x === choose)) {
            ...
            ahmet.publicParents  = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu PublicParent başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["privateParents"].some(x => x === choose)) {
            ...
            ahmet.privateParents = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu privateParents başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["aloneParents"].some(x => x === choose)) {
            ...
            ahmet.aloneParents = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu aloneParents başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["funParents"].some(x => x === choose)) {
            ...
            ahmet.funParents = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu funParents başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["registerParents",].some(x => x === choose)) {
            ...
            ahmet.registerParents = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu registerParents başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["chatChannel","chat"].some(x => x === choose)) {
            ...
            ahmet.chatChannel = log.id, await ahmet.save(), message.reply(`Başarılı bir şekilde \`Genel Sohbet\` Kanalını config dosyasına ${log} olarak ayarlandı!`)
        };
        ...
        if(["kurallar"].some(x => x === choose)) {
            ...
            ahmet.kurallar = log.id, await ahmet.save(), message.reply(`Başarılı bir şekilde \`Kurallar\` Kanalını config dosyasına ${log} olarak ayarlandı!`)
        };
        ...
        if(["cezapuanlog"].some(x => x === choose)) {
            ...
            ahmet.cezapuanlog = log.id, await ahmet.save(), message.reply(`Başarılı bir şekilde \`Cezapuan Log\` Kanalını config dosyasına ${log} olarak ayarlandı!`)
        };
        ...
        if(["transportlog"].some(x => x === choose)) {
            ...
            ahmet.transportlog = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu transportlog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["jailLogChannel","jaillog"].some(x => x === choose)) {
            ...
            ahmet.jailLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu jailLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["banLogChannel","banlog"].some(x => x === choose)) {
            ...
            ahmet.banLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu banLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["warnLogChannel","warnlog"].some(x => x === choose)) {
            ...
            ahmet.warnLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu warnLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["reklamLogChannel"].some(x => x === choose)) {
            ...
            ahmet.reklamLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu reklamLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["cmuteLogChannel","mutelog"].some(x => x === choose)) {
            ...
            ahmet.cmuteLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cmuteLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["vmuteLogChannel","vmutelog"].some(x => x === choose)) {
            ...
            ahmet.vmuteLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vmuteLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["invLogChannel","invite"].some(x => x === choose)) {
            ...
            ahmet.invLogChannel = log.id, await ahmet.save(), message.reply(`Başarılı bir şekilde \`Invie Log\` Kanalı config dosyasına ${log} olarak ayarlandı!`)
        };
        ...
        if(["teyitKanali","register"].some(x => x === choose)) {
            ...
            ahmet.teyitKanali = log.id, await ahmet.save(), message.reply(`Başarılı bir şekilde \`TeyitKanali\` rolü config dosyasına ${log} olarak ayarlandı!`)
        };
        ...
        if(["ekipLogChannel","taglog"].some(x => x === choose)) {
            ...
            ahmet.ekipLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu ekipLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["yetkiLog"].some(x => x === choose)) {
            ...
            ahmet.yetkiLog = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu yetkiLog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["marketLog"].some(x => x === choose)) {
            ...
            ahmet.marketLog = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu marketLog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
        ...
        if(["toplantiSesChannel"].some(x => x === choose)) {
            ...
            ahmet.toplantiSesChannel = log.id, await ahmet.save(),
        ...
        if(["mazaretliLogChannel"].some(x => x === choose)) {
            ...
            ahmet.mazaretliLogChannel = log.id, await ahmet.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu mazaretliLogChannel başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
