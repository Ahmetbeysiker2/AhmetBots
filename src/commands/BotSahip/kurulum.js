...
module.exports = {
  ...
  .setStyle("PRIMARY")
  .setEmoji('997855616481628252'),
  new MessageButton()
  .setCustomId("kanal")
  .setLabel("Kanal Kurulum")
  .setStyle("SUCCESS")
  .setEmoji('997855619291824238'),
  new MessageButton()
  .setCustomId("emoji")
  .setLabel("Emoji Kurulum")
  .setStyle("DANGER")
  .setEmoji('997678714689179648'),
  );
      ...
      collector.on("collect", async interaction => {
        ...
        if (interaction.customId === "emoji") {
          ...
          const emojis = [
              ...
              { name: "fill", url: "https://cdn.discordapp.com/emojis/988904540680122439.webp?size=44&quality=lossless" },
              { name: "empty", url: "https://cdn.discordapp.com/emojis/988904542412357662.webp?size=44&quality=lossless" },
              { name: "fillStart", url: "https://cdn.discordapp.com/emojis/988904538964623380.webp?size=44&quality=lossless" },
              { name: "emptyEnd", url: "https://cdn.discordapp.com/emojis/988904545587462206.webp?size=44&quality=lossless" },
              { name: "fillEnd", url: "https://cdn.discordapp.com/emojis/988904543905525760.webp?size=44&quality=lossless" },
              ...
              { name: "ahmetspotify", url: "https://cdn.discordapp.com/emojis/899337292840312912.png?size=44" },
              { name: "ahmetnetflix", url: "https://cdn.discordapp.com/emojis/941993358518284298.webp?size=96&quality=lossless" },
              { name: "ahmetexxen", url: "https://cdn.discordapp.com/emojis/900396713116835900.png?size=44" },
              { name: "ahmetblutv", url: "https://cdn.discordapp.com/emojis/900396707362246666.png?size=44" },
              { name: "ahmetnitro", url: "https://cdn.discordapp.com/emojis/941993742934614047.webp?size=96&quality=lossless" },
              { name: "ahmetyoutube", url: "https://cdn.discordapp.com/emojis/941993963013935115.gif?size=96&quality=lossless" },
              ...
              { name: "unlem", url: "https://cdn.discordapp.com/emojis/771485096741830686.webp?size=44&quality=lossless" },
              { name: "ahmetstat", url: "https://cdn.discordapp.com/emojis/951149348484415488.webp?size=96&quality=lossless" },
              { name: "ahmetlink", url: "https://cdn.discordapp.com/emojis/975535514318950400.webp?size=96&quality=lossless" },
